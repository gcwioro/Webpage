...
const metaConfig: MetaConfig = {
  de: {
    ...
    description:
      'Freelance Full-Stack Developer aus Österreich. Spezialisiert auf .NET, Vue 3 und TypeScript mit über 10 Jahren Erfahrung in System-Architektur und Cloud-Lösungen.',
    keywords:
      'Full-Stack Developer, Vue.js, .NET, TypeScript, Österreich, Freelance, Software Engineer, API Design, DDD',
  },
  en: {
    title: 'Günther Cwioro | Full-Stack Software Engineer',
    description:
      'Freelance Full-Stack Developer from Austria. Specialized in .NET, Vue 3 and TypeScript with over 10 years of experience in system architecture and cloud solutions.',
    keywords:
      'Full-Stack Developer, Vue.js, .NET, TypeScript, Austria, Freelance, Software Engineer, API Design, DDD',
  },
}
...
export function useSeoMeta(locale: ComputedRef<Locale>) {
  ...
  useHead({
    ...
    meta: [
      ...
      {
        property: 'og:locale',
        content: () => (locale.value === 'de' ? 'de_AT' : 'en_US'),
      },
